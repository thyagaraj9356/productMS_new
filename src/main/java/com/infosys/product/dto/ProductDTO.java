...
public class ProductDTO {
	...
	@Pattern(regexp = "[A-Za-z]+( [A-Za-z]+)*", message = "name should not contain Numbers and specail characters")
	String productname;
	...
	@Size(min=1,max=500)
	String description;
	@Pattern(regexp = "([^\\s]+(\\.(?i)(jpeg|png))$)", message = "No such format allowd except JPG,PNG")
	String image;
	String sellerid;
	String category;
	String subcategory;
